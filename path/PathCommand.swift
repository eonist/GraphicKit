import Foundation
/**
 * - Fixme: ⚠️️ ⚠️️ Set the values to the actual int not a pointer, one les cycle to call
 * - Fixme: ⚠️️ ⚠️️ you can do case noOp,moveTo, etc
 */
enum PathCommand: Int {
    ...
    case arcTo = 7//7 (9 values)// :- Fixme: ⚠️️ center can be generated cant it? then it should be 7 values /*startX,startY,xRadii,yRadii,rotation,largeArcFlag,sweepFlag,endX,endY,centerX,centerY*/
